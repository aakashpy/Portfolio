...
const BookAPI = (props) => {
    return (
        <div className="bg-gradient-to-r from-blue-900 via-black to-blue-900 h-auto text-center text-white ">
            {props.navbar}
                        ...
                        <tbody className="bg-gray-400">
                            <tr>
                                ...
                                <td className="border border-black">
                                    ...
                                    local server whenever you make some changes in your file. Once all installation is done open the package.json file. Under the scripts remove everythin and right ("dev":"npx nodemon index")
                                    Your script should look like this: click here
                                </td>
                            </tr>
                            <tr>
                                <td className="border border-black">
                                ...
                                <td className="border border-black">
                                    ...
                                    written while writng this syntax. Once you have written the key open the terminal and type 'node dev'. If everything is right your server should start running and your
                            ...
                            <tr>
                                ...
                                <td className="border border-black">
                                   ...
                                   side of your screen. You can see all the routes in the requirements folder. While giving POST and PUT request you have to pass data in the Body tab. Refer to the images given here POST PUT
                                </td>
                            </tr>
                        </tbody>
                    </table>
